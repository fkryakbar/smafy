<header class="z-10 py-4 bg-white shadow-md ">
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-amber-600 ">
        <!-- Mobile hamburger -->
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
                ...
                <button class="align-middle rounded-full focus:shadow-outline-amber focus:outline-none"
                    @click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account"
                    aria-haspopup="true">
                    <img class="object-cover w-8 h-8 rounded-full" src="{{ asset('image/user.png') }}" alt=""
                        aria-hidden="true" />
                </button>
