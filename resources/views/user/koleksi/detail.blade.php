                        ...
                        <form action="" method="POST" autocomplete="off">
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="text" name="title" placeholder="Masukkan judul topik"
                                    class="input input-bordered w-full" value="{{ $collection->title }}" />
                            </div>
                            <div class="form-control w-full mt-3">
                                <label class="label">
                                    <span class="label-text">Deskripsi</span>
                                </label>
                                <textarea name="description" class="textarea textarea-bordered" placeholder="Masukkan Deskripsi">{{ $collection->description }}</textarea>
                            </div>
                            <div class="form-control w-full mt-3">
                                <label class="label">
                                ...
                                <select id="topik" multiple name="packages[]"
                                    ...
                                    @foreach ($topik as $t)
                                        <option @selected($collection->packages->contains('slug', $t->slug)) value="{{ $t->slug }}">
                                            {{ $t->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-control w-full">
                                ...
                                <select class="select select-bordered" name="show_public">
                                    <option value="1" @if ($collection->show_public == '1') selected @endif>Ya
                                    </option>
                                    <option value="0" @if ($collection->show_public == '0') selected @endif>Tidak
                                    </option>
                                </select>
                            </div>
                            <div class="form-control w-full">
                                ...
                                <select class="select select-bordered" name="accept_responses">
                                    <option value="1" @if ($collection->accept_responses == '1') selected @endif>Ya
                                    </option>
                                    <option value="0" @if ($collection->accept_responses == '0') selected @endif>Tidak
                                    </option>
                                </select>
                            </div>
                            <div class="form-control w-full">
                                ...
                                <select class="select select-bordered" name="allow_to_restart_activity">
                                    <option value="1" @if ($collection->allow_to_restart_activity == '1') selected @endif>Ya
                                    </option>
                                    <option value="0" @if ($collection->allow_to_restart_activity == '0') selected @endif>Tidak
                                    </option>
                                </select>
                            </div>
                            <button type="submit"
