                        ...
                        <form action="" method="POST" autocomplete="off">
                            ...
                            <div class="form-control w-full">
                                ...
                                <select id="topic_type" class="select select-bordered" name="topic_type"
                                    onclick="check_type()">
                                    <option value="materi" @if (old('topic_type') == 'materi') selected @endif>Materi
                                    </option>
                                    <option value="kuis" @if (old('topic_type') == 'kuis') selected @endif>Kuis
                                    </option>
                                </select>
                                <label class="label">
                                    <span class="label-text italic text-red-600">Tipe topik tidak dapat diubah setelah
                                        topik dibuat</span>
                                </label>
                            </div>
                            <div id="lesson_options">
                                <div class="form-control w-full">
                                    ...
                                    <select class="select select-bordered" name="show_correction_lesson">
                                        <option value="1" @if (old('show_correction_lesson') == '1') selected @endif>Ya
                                        </option>
                                        <option value="0" @if (old('show_correction_lesson') == '0') selected @endif>Tidak
                                        </option>
                                    </select>
                            ...
                            <div id="quiz_options">
                                <div class="form-control w-full">
                                    ...
                                    <select class="select select-bordered" name="show_correction_quiz">
                                        <option value="1" @if (old('show_correction_quiz') == '1') selected @endif>Ya
                                        </option>
                                        <option value="0" @if (old('show_correction_quiz') == '0') selected @endif>Tidak
                                        </option>
                                    </select>
                            ...
                            <div class="form-control w-full">
                                ...
                                <select class="select select-bordered" name="show_result">
                                    <option value="1" @if (old('show_result') == '1') selected @endif>Ya
                                    </option>
                                    <option value="0" @if (old('show_result') == '0') selected @endif>Tidak
                                    </option>
                                </select>
                            </div>
